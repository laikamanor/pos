...
namespace AB
{
    public partial class AddCustomer_Details : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Middle Initial field is required", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            {
                MessageBox.Show("Email Address field is required", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtEmail.Focus();
            }
            else if (!checkEmail())
            {
                MessageBox.Show("Email Address field is not valid", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtEmail.Focus();
            }
            else if (string.IsNullOrEmpty(txtAddress.Text.Trim()))
            {
                MessageBox.Show("Address field is required", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtAddress.Focus();
            }
            else
            {
                ...
                birthDate = dtBirthDate.Value.ToString("yyyy-MM-dd");
