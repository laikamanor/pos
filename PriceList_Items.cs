            ...
            if (Login.jsonResult != null)
            {
                ...
                if (!token.Equals(""))
                {
                    ...
                    if (response.ErrorMessage == null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(msg.Trim()) && !isSubmit)
                        {
                            MessageBox.Show(msg, "Message", MessageBoxButtons.OK, isSubmit ? MessageBoxIcon.Information : MessageBoxIcon.Warning);
                        }
                        if (isSubmit)
                        {
                            MessageBox.Show("Price Updated", "Message", MessageBoxButtons.OK, isSubmit ? MessageBoxIcon.Information : MessageBoxIcon.Information);
                        }
